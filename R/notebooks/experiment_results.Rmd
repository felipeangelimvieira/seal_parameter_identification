...
g.x <- plot.sweep.data(sweep.dt[(axis=="x")])
g.y <- plot.sweep.data(sweep.dt[(axis=="y")])


g.savgol.x <- plot.sweep.data(sweep.savgol.dt[(axis=="x")])
g.savgol.y <- plot.sweep.data(sweep.savgol.dt[(axis=="y")])


ggplot()  + geom_line(data=sweep.dt[(episode == 0) & (axis == "x")],
                      aes(x=t,y=fx), color=.orange, alpha=0.5) +
  geom_line(data=sweep.savgol.dt[(episode == 0) & (axis == "x")],
                      aes(x=t,y=fx), color=.mauve)
